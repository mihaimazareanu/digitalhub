...
import { Address, ContactContainer, GoldTextContainer, LegalsContainer } from '../Impressum/ImpressumStyles'
import { LinksDiv, StyledLink, StyledList } from './DataProtectionStyles'
...
function DataProtection() {
  return (
    <LegalsContainer>
        ...
        <h3>All-Inkl</h3>
        <p>Anbieter ist die ALL-INKL.COM - Neue Medien Münnich, Inh. René Münnich, Hauptstraße 68, 02742
        Friedersdorf (nachfolgend All-Inkl). Details entnehmen Sie der Datenschutzerklärung von All-Inkl: 
        <StyledLink style={{marginLeft: "0.5rem", color: "#2B2D42"}} target="_blank" href="https://all-inkl.com/datenschutzinformationen/">https://all-inkl.com/datenschutzinformationen/</StyledLink>.</p>
        ...
        <LinksDiv>
            <StyledLink style={{color: "#2B2D42"}} href="https://privacy.google.com/businesses/gdprcontrollerterms/" target="_blank">https://privacy.google.com/businesses/gdprcontrollerterms/</StyledLink> <p>und</p>
            <StyledLink style={{color: "#2B2D42"}} href="https://privacy.google.com/businesses/gdprcontrollerterms/sccs/" target="_blank">https://privacy.google.com/businesses/gdprcontrollerterms/sccs/</StyledLink>    
        </LinksDiv>
        <p>Mehr Informationen zum Umgang mit Nutzerdaten finden Sie in der Datenschutzerklärung von Google:</p>
        <StyledLink style={{color: "#2B2D42"}} href="https://policies.google.com/privacy?hl=de" target="_blank">https://policies.google.com/privacy?hl=de</StyledLink>
    </LegalsContainer>
  )
}
